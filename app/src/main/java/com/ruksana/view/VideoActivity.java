...
import com.ruksana.adapter.adapterForVideo;
...
public class VideoActivity extends AppCompatActivity {
    ...
    adapterForVideo adapterForVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(VideoActivity.this));

        db = FirebaseFirestore.getInstance();

        datalist = new ArrayList<>();

        adapterForVideo = new adapterForVideo(datalist);


        recview.setAdapter(adapterForVideo);
    ...
    private void loadData() {
        ...
        db = FirebaseFirestore.getInstance();
        db.collection("VideoItems")
                .orderBy("categoryForVideo", Query.Direction.ASCENDING)
                .whereEqualTo("categoryForVideo", category)
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot d : list) {
                            Model_For_Video obj = d.toObject(Model_For_Video.class);
                            datalist.add(obj);
                        }
                        adapterForVideo.notifyDataSetChanged();
