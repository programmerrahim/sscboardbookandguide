...
public class GeographyGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(GeographyGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ভূগোল ও পরিবেশ - গাইড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "geogbook")
                .get()
