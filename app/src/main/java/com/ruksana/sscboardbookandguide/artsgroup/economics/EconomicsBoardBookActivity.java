...
public class EconomicsBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(EconomicsBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("অর্থনীতি - বোর্ড বই");
