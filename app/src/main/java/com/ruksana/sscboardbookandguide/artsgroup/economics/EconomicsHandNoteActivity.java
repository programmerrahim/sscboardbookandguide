package com.ruksana.sscboardbookandguide.artsgroup.economics;
...
public class EconomicsHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(EconomicsHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("অর্থনীতি - হ্যান্ড নোট");
