package com.ruksana.sscboardbookandguide.artsgroup.civics;
...
public class CivicsHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(CivicsHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("পৌরনীতি ও নাগরিকতা - হ্যান্ড নোট");
