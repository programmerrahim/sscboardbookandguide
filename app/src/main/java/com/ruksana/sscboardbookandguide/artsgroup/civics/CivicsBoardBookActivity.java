...
public class CivicsBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(CivicsBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("পৌরনীতি ও নাগরিকতা - বোর্ড বই");
