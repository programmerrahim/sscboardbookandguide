...
public class CivicsGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(CivicsGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("পৌরনীতি ও নাগরিকতা - গাইড বই");
