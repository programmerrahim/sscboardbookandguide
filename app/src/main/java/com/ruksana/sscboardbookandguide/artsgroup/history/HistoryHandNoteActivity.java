package com.ruksana.sscboardbookandguide.artsgroup.history;
...
public class HistoryHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HistoryHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলাদেশের ইতিহাস ও বিশ্বসভ্যতা - হ্যান্ড নোট");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "hishnote")
                .get()
