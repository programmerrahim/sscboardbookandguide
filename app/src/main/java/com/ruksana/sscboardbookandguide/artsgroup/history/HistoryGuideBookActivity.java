...
public class
HistoryGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HistoryGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলাদেশের ইতিহাস ও বিশ্বসভ্যতা - গাইড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "hisgbook")
                .get()
