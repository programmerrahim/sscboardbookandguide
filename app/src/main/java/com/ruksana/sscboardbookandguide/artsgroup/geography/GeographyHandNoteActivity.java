package com.ruksana.sscboardbookandguide.artsgroup.geography;
...
public class GeographyHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(GeographyHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ভূগোল ও পরিবেশ - হ্যান্ড নোট");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "geohnote")
                .get()
