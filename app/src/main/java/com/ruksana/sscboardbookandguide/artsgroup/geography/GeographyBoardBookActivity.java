...
public class GeographyBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(GeographyBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ভূগোল ও পরিবেশ - বোর্ড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "geobbook")
                .get()
