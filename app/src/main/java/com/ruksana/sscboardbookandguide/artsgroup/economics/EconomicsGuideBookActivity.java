...
public class EconomicsGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(EconomicsGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("অর্থনীতি - গাইড বই");
