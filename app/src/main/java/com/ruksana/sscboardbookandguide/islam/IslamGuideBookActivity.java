...
public class IslamGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(IslamGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ইসলাম শিক্ষা - গাইড বই");
