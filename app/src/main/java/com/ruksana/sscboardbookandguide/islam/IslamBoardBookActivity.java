...
public class IslamBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(IslamBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ইসলাম শিক্ষা - বোর্ড বই");
