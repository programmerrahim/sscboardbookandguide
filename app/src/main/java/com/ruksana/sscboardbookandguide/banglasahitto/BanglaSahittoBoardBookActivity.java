...
public class BanglaSahittoBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BanglaSahittoBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলা সাহিত্য - বোর্ড বই");
