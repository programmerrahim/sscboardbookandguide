package com.ruksana.sscboardbookandguide.banglasahitto;
...
public class BanglaSahittoHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BanglaSahittoHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলা সাহিত্য - হ্যান্ড নোট");
