...
public class HinduBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HinduBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("হিন্দুধর্ম শিক্ষা - বোর্ড বই");
