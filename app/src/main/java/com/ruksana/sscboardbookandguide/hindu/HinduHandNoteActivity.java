package com.ruksana.sscboardbookandguide.hindu;
...
public class HinduHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HinduHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("হিন্দুধর্ম শিক্ষা - হ্যান্ড নোট");
