...
public class HinduGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HinduGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("হিন্দুধর্ম শিক্ষা - গাইড বই");
