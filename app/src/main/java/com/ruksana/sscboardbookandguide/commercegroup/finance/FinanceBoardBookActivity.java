...
public class FinanceBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(FinanceBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ফিন্যান্স ও ব্যাংকিং - বোর্ড বই");
