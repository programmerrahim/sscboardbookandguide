package com.ruksana.sscboardbookandguide.commercegroup.finance;
...
public class FinanceHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(FinanceHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ফিন্যান্স ও ব্যাংকিং - হ্যান্ড নোট");
