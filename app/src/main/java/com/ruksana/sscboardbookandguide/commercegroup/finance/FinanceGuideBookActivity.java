...
public class FinanceGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(FinanceGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ফিন্যান্স ও ব্যাংকিং - গাইড বই");
