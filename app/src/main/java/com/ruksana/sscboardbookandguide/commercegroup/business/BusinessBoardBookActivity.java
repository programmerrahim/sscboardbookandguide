...
public class BusinessBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BusinessBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ব্যবসায় উদ্যোগ - বোর্ড বই");
