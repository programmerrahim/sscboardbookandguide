...
public class AccountingGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(AccountingGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("হিসাববিজ্ঞান - গাইড বই");
