package com.ruksana.sscboardbookandguide.commercegroup.business;
...
public class BusinessHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BusinessHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ফিব্যবসায় উদ্যোগ - হ্যান্ড নোট");
