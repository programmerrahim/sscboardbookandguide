package com.ruksana.sscboardbookandguide.commercegroup.accounting;
...
public class AccountingHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(AccountingHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("হিসাববিজ্ঞান - হ্যান্ড নোট");
