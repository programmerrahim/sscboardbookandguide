...
public class BusinessGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BusinessGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("ফব্যবসায় উদ্যোগ - গাইড বই");
