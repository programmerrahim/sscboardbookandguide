...
public class SohopathGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(SohopathGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলা সহপাঠ - গাইড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "bnsgbook")
                .get()
