...
public class SohopathBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(SohopathBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলা সহপাঠ - বোর্ড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "bnsbbook")
                .get()
