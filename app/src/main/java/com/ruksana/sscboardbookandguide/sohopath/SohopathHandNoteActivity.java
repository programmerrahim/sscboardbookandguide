package com.ruksana.sscboardbookandguide.sohopath;
...
public class SohopathHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(SohopathHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলা সহপাঠ - হ্যান্ড নোট");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "bnshnote")
                .get()
