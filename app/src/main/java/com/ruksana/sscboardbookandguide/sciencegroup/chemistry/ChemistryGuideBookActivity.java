...
public class ChemistryGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(ChemistryGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("রসায়ন - গাইড বই");
