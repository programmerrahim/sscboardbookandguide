...
public class HigherMathBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HigherMathBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("উচ্চতর গণিত - বোর্ড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "hmathbbook")
                .get()
