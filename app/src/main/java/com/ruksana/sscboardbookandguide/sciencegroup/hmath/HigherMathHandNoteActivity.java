...
public class HigherMathHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(HigherMathHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("উচ্চতর গণিত - হ্যান্ড নোট");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "hmathhnote")
                .get()
