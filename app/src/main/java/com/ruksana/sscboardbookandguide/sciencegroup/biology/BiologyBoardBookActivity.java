...
public class BiologyBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BiologyBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("জীববিজ্ঞান - বোর্ড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "biobbook")
                .get()
