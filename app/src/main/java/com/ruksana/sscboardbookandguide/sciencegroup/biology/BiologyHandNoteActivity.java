package com.ruksana.sscboardbookandguide.sciencegroup.biology;
...
public class BiologyHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BiologyHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("জীববিজ্ঞান - হ্যান্ড নোট");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "biohnote")
                .get()
