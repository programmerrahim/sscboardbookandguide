package com.ruksana.sscboardbookandguide.sciencegroup.chemistry;
...
public class ChemistryHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(ChemistryHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("রসায়ন - হ্যান্ড নোট");
