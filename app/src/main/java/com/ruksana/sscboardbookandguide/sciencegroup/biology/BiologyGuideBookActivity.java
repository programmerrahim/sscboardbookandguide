...
public class BiologyGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BiologyGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("জীববিজ্ঞান - গাইড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "biogbook")
                .get()
