package com.ruksana.sscboardbookandguide.bakoron;
...
public class BakoronHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BakoronHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("বাংলা ভাষার ব্যাকরণ ও নির্মিতি - হ্যান্ড নোট");
