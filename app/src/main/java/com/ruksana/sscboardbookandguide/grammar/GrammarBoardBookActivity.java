...
public class GrammarBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(GrammarBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("English Grammar and Composition - বোর্ড বই");
