...
public class GrammarGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(GrammarGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("English Grammar and Composition - গাইড বই");
