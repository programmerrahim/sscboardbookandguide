package com.ruksana.sscboardbookandguide.grammar;
...
public class GrammarHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(GrammarHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("English Grammar and Composition - হ্যান্ড নোট");
