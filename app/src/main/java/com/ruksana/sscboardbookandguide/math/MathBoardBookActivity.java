...
public class MathBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(MathBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("গণিত - বোর্ড বই");
