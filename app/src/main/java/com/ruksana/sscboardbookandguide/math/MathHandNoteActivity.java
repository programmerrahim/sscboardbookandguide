package com.ruksana.sscboardbookandguide.math;
...
public class MathHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(MathHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("গণিত - হ্যান্ড নোট");
