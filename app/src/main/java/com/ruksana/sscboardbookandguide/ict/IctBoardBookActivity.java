...
public class IctBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(IctBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("তথ্য ও যোগাযোগ প্রযুক্তি - বোর্ড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "ictbbook")
                .get()
