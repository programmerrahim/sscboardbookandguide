package com.ruksana.sscboardbookandguide.ict;
...
public class IctHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(IctHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("তথ্য ও যোগাযোগ প্রযুক্তি - হ্যান্ড নোট");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "icthnote")
                .get()
