...
public class IctGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(IctGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("তথ্য ও যোগাযোগ প্রযুক্তি - গাইড বই");
    ...
    private void loadData() {
        ...
        db.collection("Data")
                ...
                .whereEqualTo("category", "ictgbook")
                .get()
