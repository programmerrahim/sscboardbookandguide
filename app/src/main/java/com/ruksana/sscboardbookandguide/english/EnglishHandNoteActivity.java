package com.ruksana.sscboardbookandguide.english;
...
public class EnglishHandNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(EnglishHandNoteActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("English For Today - হ্যান্ড নোট");
