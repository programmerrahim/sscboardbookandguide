...
public class EnglishBoardBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(EnglishBoardBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("English For Today - বোর্ড বই");
