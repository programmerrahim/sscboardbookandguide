...
public class EnglishGuideBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(EnglishGuideBookActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("English For Today - গাইড বই");
